...
/*
Using elementary matrix row and column operations on the system of two diophantine equations, namely, N=an+b and N=cn+d, 
where n∈N0, it can be shown that the intersection of these two arithmetic progressions is another arithmetic progression
N=(ac)n+cδ+d where δ∈N:a|(cδ+d−b).
